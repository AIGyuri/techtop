        ...
        <GuestLayout>
            <div className="bg-blue-100 min-h-screen py-8"> {/* Módosított háttérszín */}
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    {/* Oldal címe */}
                    <h1 className="text-4xl sm:text-6xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r to-blue-500 from-black mb-16 tracking-wider">
                        Bemutatkozás
                    </h1>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-xl hover:shadow-2xl transform transition-all hover:scale-105">
                            ...
                            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-800 mb-4 hover:text-blue-700 transition-all">Petra</h2>
                            ...
                            <div className="mt-10 bg-blue-100 p-4 rounded-xl">
                                <h3 className="text-lg sm:text-xl font-semibold text-gray-700">Elérhetőség</h3>
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-xl hover:shadow-2xl transform transition-all hover:scale-105">
                            ...
                            <h2 className="text-2xl sm:text-3xl font-semibold text-gray-800 mb-4 hover:text-blue-700 transition-all">Gyuri</h2>
                            <p className="text-base sm:text-lg text-gray-600 leading-relaxed mb-4">
